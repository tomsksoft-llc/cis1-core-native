...
template <class Type>
struct sys_stream_interface
{
    virtual ~sys_stream_interface() = default;

    virtual sys_stream_interface& close() = 0;
    
    virtual sys_stream_interface& bind_pipe(boost::process::async_pipe&) = 0;
};
